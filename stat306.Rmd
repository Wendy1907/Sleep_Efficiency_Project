...
```
Deep.sleep.percentage is highly correlated with Light.sleep.percentage. And the
hour of wakeup is highly correlated with the hour of going to bed.
```{r}
...
linear regression using the full transformed dataset.
```{r}
